...
import { cachedFollowUp, SERVER_AI_TIMEOUT_MS, SERVER_PRO_TIMEOUT_MS, withTimeout } from "@/lib/demoCache";
...
export async function POST(req: Request) {
  ...
  try {
    out = await withTimeout(draftFollowUpText(kind, clean), kind === "ftc" ? SERVER_PRO_TIMEOUT_MS : SERVER_AI_TIMEOUT_MS);
  } catch {}
